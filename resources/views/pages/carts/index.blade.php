        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6">
                ...
                @if(count($cartItems) > 0)
                                    ...
                                    <tbody class="divide-y divide-gray-200">
                                        ...
                                        @foreach($cartItems as $index => $item)
                                            ...
                                            <tr class="hover:bg-gray-50">
                                                <td class="py-3 px-4">
                                                    <img src="https://placehold.co/64x64" alt="{{ $item['name'] }}" class="w-16 h-16 object-cover rounded">
                                                </td>
                                ...
                                <div class="p-6">
                                    ...
                                    <div class="space-y-3 mt-3">
                                        ...
                                        <div class="flex justify-between pt-2">
                                            ...
                                            <span class="text-lg font-bold text-gray-800">${{ number_format($subtotal - $discount, 2) }}</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mt-6 bg-blue-50 border-l-4 border-blue-500 text-blue-700 p-4 rounded">
                                        ...
                                        @if($totalQuantity < 3)
                                            <p class="mt-1 text-xs">You currently have {{ $totalQuantity }} item(s). Add {{ 3 - $totalQuantity }} more to qualify for the discount.</p>
                                        @else
                                    ...
                                    <div class="mt-6">
                                        <button class="w-full bg-cyan-500 text-white py-3 px-4 rounded-md font-medium hover:bg-cyan-600 transition duration-200">
                                            Proceed to Checkout
                                        </button>
                                    </div>
                                </div>
                    ...
                    <div class="mt-6">
                        <a href="/" class="inline-block bg-teal-500 text-white px-4 py-2 rounded hover:bg-teal-600 transition duration-200">
                            Continue Shopping
                        </a>
                    </div>
                @else
